...
describe('happy', () => {
  test('pass "https://pokeapi.co/api/v2/pokemon/000000000000000000/" to equal "000000000000000000"',
    () => {
      expect(getPeriodicNumberFromUrl('https://pokeapi.co/api/v2/pokemon/000000000000000000/'))
        .toEqual('000000000000000000')
    })
